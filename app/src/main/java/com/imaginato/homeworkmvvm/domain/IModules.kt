...
val loginRepositoryModules = module {
...
private fun provideUserDatabase(application: Application): UserDataBase {
    return Room.databaseBuilder(application, UserDataBase::class.java, "User-Database")
        .fallbackToDestructiveMigration()
        .build()
}
